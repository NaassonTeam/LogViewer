                    ...
                    <tr>
                        @foreach($row as $key => $value)
                            <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                ...
                                @else
                                    <a href="{{ route('log-viewer::logs.filter', [$type, $date, $key]) }}">
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ route('log-viewer::logs.show', [$type, $date]) }}" class="btn btn-sm btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ route('log-viewer::logs.download', [$type, $date]) }}" class="btn btn-sm btn-success">
