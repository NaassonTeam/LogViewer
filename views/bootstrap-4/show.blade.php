  ...
  <div class="row">
    <div class="col-lg-2">
      ...
      <div class="card mb-4">
        ...
        <div class="list-group list-group-flush log-menu">
          ...
          @foreach($log->menu($type) as $levelKey => $item)
            @if ($item['count'] === 0)
    ...
    <div class="col-lg-10">
      ...
      <div class="card mb-4">
        <div class="card-header">
          ...
          <div class="group-btns pull-right">
            <a href="{{ route('log-viewer::logs.download', [$type, $log->date]) }}" class="btn btn-sm btn-success">
        ...
        <div class="card-footer">
          {{-- Search --}}
          <form action="{{ route('log-viewer::logs.search', [$type, $log->date, $level]) }}" method="GET">
              ...
              <div class="input-group">
                ...
                <div class="input-group-append">
                  @unless (is_null($query))
                    <a href="{{ route('log-viewer::logs.show', [$type, $log->date]) }}" class="btn btn-secondary">
      ...
      <div class="card mb-4">
        @if ($entries->hasPages())
          <div class="card-header">
                        <span class="badge badge-info float-rigLevelsht">
                    ...
                    <td colspan="5" class="stack py-0">
                      ...
                      @if ($entry->hasContext())
                        <div class="stack-content collapse" id="log-context-{{ $key }}">
                          ...
                          <div class="json_{{ $key }}"></div>

                            <?php
                            try {
                                $jsonObj  = json_decode($entry->context(), true);
                                ...
                                $jsonViewContext .= '
                                              ...
                                              document.querySelector(".json_' . $key . '").appendChild(jsonViewer.getContainer());
                                              jsonViewer.showJSON(JSON.parse(cleanJson(\'' . json_encode($jsonObj) . '\')));
                                              ';


                            } catch (Exception $e) {
                                echo '<pre>' . $entry->context(). '</pre>';
                            }
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (data.result === 'success') {
						...
						location.replace("{{ route('log-viewer::logs.list', [$type]) }}")
					} else {
